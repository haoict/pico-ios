<template>
  <div class="min-h-screen bg-oled-dark text-white p-6 pt-16">
    ...
    <div class="flex items-center gap-4 mb-8">
      <button @click="$router.back()" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center active:bg-white/20 transition-all">
      ...
      <h1 class="text-3xl font-pico-crisp text-white drop-shadow-md">Saved Data</h1>
    </div>
    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div v-else-if="saves.length === 0" class="flex flex-col items-center justify-center py-20 text-white/30">
      ...
      <div v-else class="space-y-6 pb-20 overflow-y-auto h-[calc(100vh-10rem)] px-1">
        <div v-for="(group, index) in groupedSaves" :key="group.title" class="animate-fade-in">
          <!-- group header -->
          <h4 class="py-2 px-1 text-white/40 text-xs font-bold uppercase tracking-widest mb-2 border-b border-white/5">
            {{ group.title }}
          </h4>
          ...
          <div class="space-y-2">
            <div
              ...
              <div class="flex items-center gap-3 overflow-hidden">
                <div class="w-10 h-10 rounded-lg bg-indigo-500/20 flex items-center justify-center shrink-0 border border-white/5">
                ...
                <div class="flex flex-col min-w-0">
                  <span class="text-white text-sm font-medium truncate font-pico leading-tight uppercase">
                    {{ save.simpleName }}
                  </span>
              ...
              <div class="flex items-center gap-1">
                ...
                <button
                  ...
                  :class="[
                    activeSaveIndex === getGlobalIndex(index, fileIndex) && activeBtnIndex === 0
                ...
                <button
                  ...
                  class="p-2 rounded-lg transition-all"
                  :class="[
                    activeSaveIndex === getGlobalIndex(index, fileIndex) && activeBtnIndex === 1
                ...
                <button
                  ...
                  class="p-2 rounded-lg transition-all"
                  :class="[
                    activeSaveIndex === getGlobalIndex(index, fileIndex) && activeBtnIndex === 2
...
async function loadState(save) {
  ...
  const matchingGame = libraryStore.games.find(g => g.name.includes(save.cartName));
  let targetCart = matchingGame ? matchingGame.filename : save.cartName + '.p8.png';
