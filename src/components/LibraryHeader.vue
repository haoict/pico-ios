  ...
  <div class="flex flex-col gap-6 mb-8 px-2 !relative !z-[100] !pointer-events-auto">
    ...
    <div class="flex justify-between items-center mb-1">
      <div class="flex flex-col">
        <h1 class="font-pico-crisp text-white drop-shadow-md text-[clamp(1.5rem,5vw,3rem)]">Library</h1>
        <span class="text-xs font-medium text-white/40 tracking-wider uppercase mt-1"> {{ gamesCount }} Cartridges </span>
      </div>
    ...
    <div class="flex gap-3">
      ...
      <div class="relative min-w-[140px] z-[200]">
        <button
          @click="$emit('update:sortDropdownOpen', !sortDropdownOpen)"
        ...
        <transition name="fade">
          <div
            ...
            <div
              ...
              :class="sortBy === opt.value ? 'bg-purple-500/20 text-purple-300 font-bold' : 'text-white/60'"
      ...
      <button
        @click="$emit('update:gridSize', cycleGridSizeValue())"
